...
import { Store, CreditCard, Clock, AlertTriangle, DollarSign, Loader2 } from 'lucide-react';
import {
  LineChart,
  Line,
  BarChart,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <StatCard
          title="MRR"
          value={stats.mrr != null ? `R$ ${Number(stats.mrr).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}` : 'R$ 0,00'}
